...
const AddSecretPage = () => {
    ...
    return (
        <>
            ...
            <m.CardPanel>Adds new secrets to your Gopass stores. After clicking the Add-button, your new secret will be pushed to remote directly.</m.CardPanel>
            ...
            <m.Row>
                ...
                <div className='secret-value-field-row'>
                    ...
                    <textarea
                        className='secret-value-textarea'
                ...
                <m.Col s={12}>
                    <m.Button
                        ...
                        onClick={() => setValue(generateRandomValue(Settings.getUserSettings().secretValueLength))}
                        waves='light'
                    >
                        {shuffleButtonLabel}
                    </m.Button>
